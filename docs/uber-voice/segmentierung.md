...
Die Entwicklung von SuttaCentral Voice beruht ganz auf dieser Segmentierungstechnik; das ist der Grund, weshalb nur segmentierte Texte voll unterstützt werden können (siehe [Support-Richtlinien](https://github.com/sc-voice/sc-voice/wiki/Support%E2%80%90Richtlinien)).
...
```
Dadurch wird es möglich, dass Sie ein Sutta, Segment für Segment, abwechselnd auf Pali und Deutsch hören können (siehe [Einstellungen](https://github.com/sc-voice/sc-voice/wiki/Einstellungen)).
